...
var (
	ErrInvalidConnectionType    = errors.New("dualSense: can't detect connection type")
	ErrControllerIsConnected    = errors.New("dualSense: controller is already connected")
	ErrControllerIsNotConnected = errors.New("dualSense: controller is not connected")
	ErrControllerIsListening    = errors.New("dualSense: controller is already listening for events")
)
